...
export function useUnitConversion() {
  ...
  const convertAmount = useCallback((amount: string, unit: string): { amount: string; unit: string } => {
  ...
  const formatIngredient = useCallback((amount: string, unit: string, name: string): string => {
