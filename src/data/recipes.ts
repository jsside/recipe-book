...
export const ingredientCategories: IngredientCategory[] = [
  { id: '1', name: 'Chicken', image: 'https://images.unsplash.com/photo-1587593810167-a84920ea0781?w=400&q=80', recipeCount: 245 },
  { id: '2', name: 'Pasta', image: 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=400&q=80', recipeCount: 189 },
  { id: '3', name: 'Salmon', image: 'https://images.unsplash.com/photo-1485921325833-c519f76c4927?w=400&q=80', recipeCount: 156 },
  { id: '4', name: 'Beef', image: 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=400&q=80', recipeCount: 203 },
  { id: '5', name: 'Eggs', image: 'https://images.unsplash.com/photo-1518569656558-1f25e69d93d7?w=400&q=80', recipeCount: 178 },
  { id: '6', name: 'Rice', image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&q=80', recipeCount: 134 },
  { id: '7', name: 'Vegetables', image: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400&q=80', recipeCount: 312 },
  { id: '8', name: 'Cheese', image: 'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=400&q=80', recipeCount: 167 },
];
...
export const recipes: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      { id: '3', name: 'Black olives', amount: '100', unit: 'g', category: 'Pantry' },
      { id: '4', name: 'Capers', amount: '2', unit: 'tbsp', category: 'Pantry' },
      { id: '5', name: 'Garlic cloves', amount: '3', unit: '', category: 'Vegetables' },
      { id: '6', name: 'Fresh basil', amount: '1', unit: 'bunch', category: 'Herbs' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '3', name: 'Parmesan cheese', amount: '80', unit: 'g', category: 'Dairy' },
      { id: '4', name: 'Garlic cloves', amount: '4', unit: '', category: 'Vegetables' },
      { id: '5', name: 'Lemon', amount: '1', unit: '', category: 'Citrus' },
      { id: '6', name: 'Chili flakes', amount: '1', unit: 'tsp', category: 'Spices' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '3', name: 'Soy sauce', amount: '2', unit: 'tbsp', category: 'Pantry' },
      { id: '4', name: 'Garlic cloves', amount: '2', unit: '', category: 'Vegetables' },
      { id: '5', name: 'Sesame seeds', amount: '1', unit: 'tbsp', category: 'Pantry' },
      { id: '6', name: 'Spring onions', amount: '2', unit: '', category: 'Vegetables' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '3', name: 'Cucumber', amount: '1', unit: '', category: 'Vegetables' },
      { id: '4', name: 'Cherry tomatoes', amount: '200', unit: 'g', category: 'Vegetables' },
      { id: '5', name: 'Feta cheese', amount: '100', unit: 'g', category: 'Dairy' },
      { id: '6', name: 'Hummus', amount: '4', unit: 'tbsp', category: 'Pantry' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '3', name: 'Greek yogurt', amount: '100', unit: 'g', category: 'Dairy' },
      { id: '4', name: 'Mixed berries', amount: '150', unit: 'g', category: 'Fruit' },
      { id: '5', name: 'Honey', amount: '2', unit: 'tbsp', category: 'Pantry' },
      { id: '6', name: 'Chia seeds', amount: '1', unit: 'tbsp', category: 'Pantry' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '3', name: 'Jasmine rice', amount: '300', unit: 'g', category: 'Grains' },
      { id: '4', name: 'Cucumber', amount: '1', unit: '', category: 'Vegetables' },
      { id: '5', name: 'Eggs', amount: '4', unit: '', category: 'Eggs' },
      { id: '6', name: 'Kimchi', amount: '100', unit: 'g', category: 'Fermented' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '3', name: 'Coconut milk', amount: '400', unit: 'ml', category: 'Pantry' },
      { id: '4', name: 'Thai basil', amount: '1', unit: 'bunch', category: 'Herbs' },
      { id: '5', name: 'Bamboo shoots', amount: '200', unit: 'g', category: 'Vegetables' },
      { id: '6', name: 'Fish sauce', amount: '2', unit: 'tbsp', category: 'Pantry' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '4', name: 'Chili flakes', amount: '1', unit: 'tsp', category: 'Spices' },
      { id: '5', name: 'Lemon', amount: '1', unit: '', category: 'Citrus' },
      { id: '6', name: 'Microgreens', amount: '1', unit: 'handful', category: 'Vegetables' },
    ],
    instructions: [
